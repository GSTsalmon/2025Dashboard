...
MasterpH2025$Site <- factor(MasterpH2025$Site,levels=c("Saysell's (km 46)","70.2 Trestle (km 40)", "Skutz Falls (km 32)","US JUB (km 4)",
                                                       "DS JUB (km 5)","DS Somenos (km 3)"))
...
MasterDO2025$Site <- factor(MasterDO2025$Site, levels=c("Saysell's","70.2 Trestle", "Skutz Falls",  "DS JUB", "US JUB", "DS Somenos" ))
