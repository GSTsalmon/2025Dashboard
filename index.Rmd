...
DOSaysells2025New <- DOSaysells2025[c(2,3,4,5)]
filtered_SaysellsDOdata <- na.omit(DOSaysells2025New)
...
DOTrestle2025New <- DOTrestle2025[c(2,3,4,5)]
filtered_TrestleDOdata <- na.omit(DOTrestle2025New)
...
filtered_DODSJUB2025 <- na.omit(DODSJUB2025New)
...
DOUSJUB2025New <- DOUSJUB2025[c(2, 4,3,8)]
