...
data.table::setnames(DODSJUB2025,'Temperature..W.DO.22097018....C','Temp')
...
DOUSJUB2025 <- DOUSJUB2025[c(1, 2, 4,3,5)]
filtered_DOUSJUB2025 <- na.omit(DOUSJUB2025)


MasterDO2025<- rbind(filtered_SaysellsDOdata,filtered_TrestleDOdata,filtered_DODSJUB2025,filtered_DOUSJUB2025)
...
data.table::setnames(pHTrestle2025,'Temperature.....C.','Temp')
data.table::setnames(pHTrestle2025,'Millivolts....mv.','mv')
...
MasterpH2025<- rbind(filtered_SaysellspHdata,filtered_TrestlepHdata, filtered_pHDSJUB2025,filtered_pHUSJUB2025)
