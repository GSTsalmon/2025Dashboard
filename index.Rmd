...
pHSkutz$Site <- "Skutz Falls - Continious (km 32)"
...
MasterpH2025$Site <- factor(MasterpH2025$Site,levels=c("Saysell's (km 46)","70.2 Trestle (km 40)", "Skutz Falls - Remote (km 32)","Skutz Falls - Continious (km 32)","US JUB (km 5)", "DS JUB (km 4)","DS Somenos (km 3)"))
