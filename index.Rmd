...
RealtimeData$Site <- "Skutz Falls - 1 (km 32)"
...
pHSkutz$Site <- "Skutz Falls - 2 (km 32)"
...
MasterpH2025$Site <- factor(MasterpH2025$Site,levels=c("Saysell's (km 46)","70.2 Trestle (km 40)", "Skutz Falls - 1 (km 32)","Skutz Falls - 2 (km 32)","US JUB (km 5)", "DS JUB (km 4)","DS Somenos (km 3)"))
...
DOSkutzRealTime$Site <- "Skutz Falls - 1"
...
filtered_DOUSJUB2025<- na.omit(filtered_DOUSJUB2025)
...
MasterDO2025$Site <- factor(MasterDO2025$Site, levels=c("Saysell's","70.2 Trestle", "Skutz Falls - 1", "US JUB", "DS JUB", "DS Somenos" ))
