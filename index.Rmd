...
DOSaysells2025$Site<-factor(DOSaysells2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
...
DOTrestle2025$Site<-factor(DOTrestle2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
...
DODSJUB2025$Site<-factor(DODSJUB2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
...
DOUSJUB2025$Site<-factor(DOUSJUB2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
...
DOSomenos2025$Site<-factor(DOSomenos2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
...
pHSaysells2025$Site<-factor(pHSaysells2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
...
pHTrestle2025$Site<-factor(pHTrestle2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
...
pHUSJUB2025$Site<-factor(pHUSJUB2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
...
pHSomenos2025$Site<-factor(pHSomenos2025$Site,levels=c("Saysell's","70.2 Trestle", "US JUB", "DS JUB", "DS Somenos"))
filtered_pHSomenos2025 <- na.omit(pHSomenos2025)

MasterpH2025<- rbind(filtered_SaysellspHdata,filtered_TrestlepHdata, filtered_pHDSJUB2025, filtered_pHUSJUB2025, filtered_pHSomenos2025)
